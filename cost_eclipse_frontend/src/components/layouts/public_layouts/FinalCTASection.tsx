...
import { FEATURES, SIGNUP } from '@/constants/app_urls';
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-5xl mx-auto text-center text-white">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-3xl mx-auto leading-relaxed">
            Join thousands of users who've transformed their financial lives with CostEclipse. Start
            your journey from financial obscurity to complete clarity today.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="p-6 bg-white/10 backdrop-blur-sm border border-white/20">
              ...
              <div className="text-sm opacity-80">
                Optimized performance for instant financial insights
              </div>
            </Card>
            <Card className="p-6 bg-white/10 backdrop-blur-sm border border-white/20">
              ...
              <div className="text-sm opacity-80">
                Join 75,000+ users managing their finances smarter
              </div>
            </Card>
          </div>
          ...
          <div className="space-y-4 opacity-90">
            <p className="text-lg font-medium">Your financial clarity is just one click away.</p>
