...
export function HowItWorksSection() {
  const steps = [
    {
      ...
      description:
        'Start by creating your account and choosing your role — salaried, business owner, or freelancer. Customize preferences based on your financial habits.',
      detailedDescription:
        'Our smart onboarding process adapts to your financial situation, providing personalized templates and recommendations from day one.',
      features: [
    ...
    },
    {
      ...
      description:
        'Log daily income, expenses, and recurring bills. For group activities, create events and assign shared expenses.',
      detailedDescription:
        'Effortlessly track your financial activities with intelligent categorization and seamless group expense management.',
      features: [
      ...
      mockUI: {
        recentTransactions: [
          { name: 'Grocery Shopping', amount: 67.5, category: 'Food' },
          { name: 'Gas Station', amount: 45.0, category: 'Transport' },
    ...
    },
    {
      ...
      description:
        'View your dashboards: monthly trends, savings goals, and category-wise breakdowns. Get AI-based insights to manage money better.',
      detailedDescription:
        'Transform your financial data into actionable insights with powerful analytics and personalized recommendations.',
      features: [
    ...
    },
    {
      ...
      description:
        'Whether solo or with friends, settle expenses, share summaries, or export reports effortlessly.',
      detailedDescription:
        'Seamlessly switch between personal finance management and group collaboration as your needs change.',
      features: [
  ...
  return (
    <section
      id="how-it-works"
      className="py-16 lg:py-24 bg-gradient-to-br from-background via-accent/20 to-primary/5"
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">Get Started in 4 Simple Steps</h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            From signup to mastering your finances, CostEclipse makes every step intuitive and
            rewarding. Join thousands who've transformed their financial lives in minutes, not
            months.
          </p>
        </div>
                        ...
                        <div className="bg-accent/30 p-4 rounded-lg">
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="grid grid-cols-2 gap-1">
                                {step.mockUI.userTypes?.slice(0, 2).map((type, i) => (
                                  <div
                                    key={i}
                                    className="text-xs bg-background/60 p-2 rounded text-center"
                                  >
                                    {type}
                                  </div>
                                ))}
                              ...
                              <div className="text-xs">
                                Setup Progress: {step.mockUI.setupProgress}%
                              </div>
                          ...
                          {step.id === 2 && (
                            <div className="space-y-2">
                              ...
                              {step.mockUI.recentTransactions?.slice(0, 2).map((transaction, i) => (
                                <div
                                  key={i}
                                  className="flex justify-between text-xs bg-background/60 p-2 rounded"
                                >
                              ...
                              <div className="text-xs pt-1">
                                Group Event: {step.mockUI.groupEvent?.name} (
                                {step.mockUI.groupEvent?.participants} people)
                              </div>
                            </div>
                          )}
                          ...
                          {step.id === 3 && (
                            <div className="space-y-2">
                              ...
                              <Progress
                                value={
                                  step.mockUI.savingsGoal
                                    ? (step.mockUI.savingsGoal.current /
                                        step.mockUI.savingsGoal.target) *
                                      100
                                    : 0
                                }
                                className="h-2"
                          ...
                          <div className="space-y-3">
                            <div className="grid grid-cols-2 gap-2">
                              {step.mockUI.userTypes?.map((type, i) => (
                                <div
                                  key={i}
                                  className="text-sm bg-background/60 p-3 rounded text-center"
                                >
                                  {type}
                                </div>
                              ))}
                        ...
                        {step.id === 2 && (
                          <div className="space-y-3">
                            ...
                            {step.mockUI.recentTransactions?.map((transaction, i) => (
                              <div
                                key={i}
                                className="flex justify-between text-sm bg-background/60 p-3 rounded"
                              >
                                <span>{transaction.name}</span>
                                <span className="font-medium">${transaction.amount}</span>
                              </div>
                            ...
                            <div className="bg-primary/10 p-3 rounded">
                              <div className="text-sm font-medium">
                                {step.mockUI.groupEvent?.name}
                              </div>
                              <div className="text-xs text-muted-foreground">
                                {step.mockUI.groupEvent?.participants} participants • $
                                {step.mockUI.groupEvent?.totalAmount}
                              </div>
                            </div>
                          </div>
                        )}
                        ...
                        {step.id === 3 && (
                          <div className="space-y-3">
                            ...
                            <div className="space-y-2">
                              ...
                              />
                              <div className="text-xs text-center">
                                ${step.mockUI.savingsGoal?.current ?? 0} / $
                                {step.mockUI.savingsGoal?.target ?? 0}
                              </div>
                            </div>
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  Join thousands who've already taken control of their finances. Start your journey
                  today with our simple 4-step process.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to={SIGNUP}>
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-primary to-success hover:from-primary/90 hover:to-success/90 group"
                  >
                    Get Started Now
